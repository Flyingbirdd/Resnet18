...
def main():
    ...
    args.store_name = '#'.join(
        ["dataset: " + args.dataset, "arch: " + args.arch, "imbanlance_rate: " + str(args.imbanlance_rate), 'rho',
         str(args.rho), 'cw', str(args.contrast_weight),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_train_txt', type=str, default='./data/data_txt/ImageNet_LT_train.txt',
                        help="dataset txt for train data")
    parser.add_argument('--dir_test_txt', type=str, default='./data/data_txt/ImageNet_LT_test.txt',
                        help="dataset txt for test data")
    ...
    parser.add_argument('--resample_weighting', default=0.2, type=float,
